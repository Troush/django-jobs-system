...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_vacancy', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=250, db_index=True)),
            ('jobs_category', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['core.JobsCategory'])),
            ('office_location', self.gf('django.db.models.fields.CharField')(max_length=250, db_index=True)),
            ('keyword', self.gf('django.db.models.fields.CharField')(max_length=250, db_index=True)),
            ('is_checked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('sex', self.gf('django.db.models.fields.CharField')(default='MAN', max_length=12, db_index=True)),
            ('education', self.gf('django.db.models.fields.CharField')(default='S', max_length=2, db_index=True)),
            ('experience', self.gf('django.db.models.fields.CharField')(default='S', max_length=2, db_index=True)),
        ))
        db.send_create_signal(u'core', ['Vacancy'])


    def backwards(self, orm):
        # Deleting model 'Vacancy'
        db.delete_table(u'core_vacancy')
    ...
    models = {
        ...
        u'core.vacancy': {
            ...
            'office_location': ('django.db.models.fields.CharField', [], {'max_length': '250', 'db_index': 'True'}),
            'sex': ('django.db.models.fields.CharField', [], {'default': "'MAN'", 'max_length': '12', 'db_index': 'True'}),
