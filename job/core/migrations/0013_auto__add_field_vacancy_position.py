...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vacancy.position'
        db.add_column(u'core_vacancy', 'position',
                      self.gf('django.db.models.fields.CharField')(default='S', max_length=250, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vacancy.position'
        db.delete_column(u'core_vacancy', 'position')
