...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Candidate.phone'
        db.alter_column(u'core_candidate', 'phone', self.gf('django.db.models.fields.CharField')(max_length=24))

        # Changing field 'Company.phone'
        db.alter_column(u'core_company', 'phone', self.gf('django.db.models.fields.CharField')(max_length=24))

    def backwards(self, orm):

        # Changing field 'Candidate.phone'
        db.alter_column(u'core_candidate', 'phone', self.gf('django.db.models.fields.IntegerField')(max_length=24))
