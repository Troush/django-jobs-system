...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Candidate.looking_for'
        db.add_column(u'core_candidate', 'looking_for',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['core.JobsCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Candidate.looking_for'
        db.delete_column(u'core_candidate', 'looking_for_id')
